...
var Images = (_temp = _class = function (_Component) {
  ...
  Images.prototype.renderOne = function renderOne() {
    ...
    return _react2.default.createElement(_core.Grid, { container: true }, _react2.default.createElement(_core.Grid, { item: true, xs: 12, md: 12, className: 'border height-one background', onClick: this.openModal.bind(this, 0), style: { background: 'url(' + images[0] + ')' } }, overlay));
  };
  ...
  Images.prototype.renderTwo = function renderTwo() {
    ...
    return _react2.default.createElement(_core.Grid, { container: true }, _react2.default.createElement(_core.Grid, { item: true, xs: 6, md: 6, className: 'border height-two background', onClick: this.openModal.bind(this, conditionalRender ? 1 : 0), style: { background: 'url(' + (conditionalRender ? images[1] : images[0]) + ')' }
    }, this.renderOverlay()), _react2.default.createElement(_core.Grid, { item: true, xs: 6, md: 6, className: 'border height-two background', onClick: this.openModal.bind(this, conditionalRender ? 2 : 1), style: { background: 'url(' + (conditionalRender ? images[2] : images[1]) + ')' } }, overlay));
  };
  ...
  Images.prototype.renderThree = function renderThree(more) {
    ...
    return _react2.default.createElement(_core.Grid, { container: true }, _react2.default.createElement(_core.Grid, { item: true, xs: 4, className: 'border height-three background', onClick: this.openModal.bind(this, conditionalRender ? 1 : 2), style: { background: 'url(' + (conditionalRender ? images[1] : images[2]) + ')' } }, this.renderOverlay(conditionalRender ? 1 : 2)), _react2.default.createElement(_core.Grid, { item: true, xs: 4, className: 'border height-three background', onClick: this.openModal.bind(this, conditionalRender ? 2 : 3), style: { background: 'url(' + (conditionalRender ? images[2] : images[3]) + ')' } }, this.renderOverlay(conditionalRender ? 2 : 3)), _react2.default.createElement(_core.Grid, { item: true, xs: 4, className: 'border height-three background', onClick: this.openModal.bind(this, conditionalRender ? 3 : 4), style: { background: 'url(' + (conditionalRender ? images[3] : images[4]) + ')' } }, overlay));
  };
  ...
  Images.prototype.renderOverlay = function renderOverlay(id) {
    ...
    return [_react2.default.createElement('div', { key: 'cover-' + id, className: 'cover slide', style: { backgroundColor: overlayBackgroundColor } }), _react2.default.createElement('div', { key: 'cover-text-' + id, className: 'cover-text slide animate-text', style: { fontSize: '100%' } }, renderOverlay())];
  };
  ...
  Images.prototype.renderCountOverlay = function renderCountOverlay(more) {
    ...
    return [more && _react2.default.createElement('div', { key: 'count', className: 'cover' }), more && _react2.default.createElement('div', { key: 'count-sub', className: 'cover-text', style: { fontSize: '200%' } }, _react2.default.createElement('p', null, '+', extra))];
  };
  ...
  Images.prototype.render = function render() {
    ...
    return _react2.default.createElement('div', { className: 'grid-container' }, [1, 3, 4].includes(imagesToShow.length) && this.renderOne(), imagesToShow.length >= 2 && imagesToShow.length != 4 && this.renderTwo(), imagesToShow.length >= 4 && this.renderThree(), modal && _react2.default.createElement(_Modal2.default, { onClose: this.onClose, index: index, images: images }));
  };
